...
SRC_V2_ADX_CONFIG = SrcV2Config(
    ...
    close_need=2,
    stop_loss_pct=0.030,
    trailing_stop_pct=0.050,
    use_daily_adx_filter=True,
    adx_threshold=25.0,
    strict_stoch_oversold=8.0,
    strict_cci_oversold=-150.0,
    strict_rsi_oversold=42.0,
    strict_open_prev_need=1,
    strict_open_cross_need=2,
    strict_scr_threshold=0.10,
    use_opening_time_filter=True,
    opening_block_minutes=5,
    reentry_cooldown_bars=1,
    use_volume_combo_filter=True,
    volume_combo_mode="and",
    obv_slope_lookback=3,
    obv_slope_min=0.3,
    vwap_gap_min_pct=0.0,
    use_extreme_stop_flex=True,
    flex_extreme_count=1,
    flex_stop_loss_add_pct=0.010,
    flex_trailing_add_pct=0.012,
)
